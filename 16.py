    ...
    def map_table(self, page):
        ...
        for i in range(len(self.table)):
            if self.table[i][1] == -1:
                free.append(i)
        if not free:
            print("Error: No free frames available.")
            return
...
page = logical_addr // page_table.page_size  # Corrected to use page_size
offset = logical_addr % page_table.page_size
...
if physical_address is not None:
    ...
    print("Error: Page not found in the page table.")
