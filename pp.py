def non_preemptive_priority(processes, arrival_time, burst_time, priority):
    ...
    # Sort the processes by arrival time and priority (non-preemptive)
...
# Calculate and print average waiting time and average turnaround time for non-preemptive
...
# Calculate and print average waiting time and average turnaround time for preemptive
